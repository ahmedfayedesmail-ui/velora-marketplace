...
const CORE_AR={
  ...
  'Payment':'الدفع',
  'Shipping':'الشحن',
  'Shipping quote ready.':'تم حساب عرض الشحن.',
  'Shipping configuration required for one or more sellers.':'يلزم إعداد الشحن لبائع واحد أو أكثر.',
  'Shipping quote unavailable.':'تعذر حساب عرض الشحن.',
  'Shipping quote will be calculated from configured seller rates.':'سيتم حساب الشحن من أسعار البائعين المهيأة.',
  'PAYMENT_METHOD_NOT_OPERATIONAL':'طريقة الدفع غير مفعلة حاليًا.',
  'SHIPPING_CONFIGURATION_REQUIRED':'يلزم إعداد الشحن قبل إتمام الطلب.',
  'PAYMENT_METHOD_REQUIRED':'اختر طريقة دفع متاحة.',
  'Payment method is not operational for this route.':'طريقة الدفع غير متاحة لهذا المسار.',
  'Shipping Rate Configuration':'إعداد أسعار الشحن',
  'Configure seller shipping rates. External carrier integration is not assumed; Velora Manual Fulfillment is the current fallback.':'اضبط أسعار الشحن للبائعين. لا نفترض وجود شركة شحن خارجية؛ وVelora Manual Fulfillment هو الخيار الاحتياطي الحالي.',
  'Save shipping rate':'حفظ سعر الشحن',
  'No shipping rates configured.':'لا توجد أسعار شحن مهيأة.',
  ...
  'I agree to the published Terms of Service and Privacy Policy, and any applicable promotion or gift card terms.':'أوافق على شروط الاستخدام وسياسة الخصوصية المنشورة، وعلى أي شروط سارية للعروض أو بطاقات الهدايا.',
  'I agree to the published seller agreement, subscription terms and commission terms applicable to this purchase.':'أوافق على اتفاقية البائع وشروط الاشتراك وشروط العمولة المنشورة والسارية على هذا الشراء.',
  'Legal acceptance is required before subscription checkout.':'يلزم قبول المستندات القانونية قبل إتمام شراء الاشتراك.',
  'No published policy is available yet.':'لا توجد سياسة منشورة متاحة حتى الآن.',
  'Policies are not published yet.':'لم يتم نشر السياسات بعد.',
  'Promotions & Deals':'العروض والصفقات',
  'Platform promotions are server-governed and non-stackable with coupons in the MVP.':'عروض المنصة محكومة من الخادم وغير قابلة للجمع مع الكوبونات في نسخة MVP.',
  'Create platform promotion':'إنشاء عرض للمنصة',
  'No promotions configured.':'لا توجد عروض مهيأة.',
  'Gift Cards':'بطاقات الهدايا',
  'Gift cards are stored-value tender and redeemed server-side with concurrency protection.':'بطاقات الهدايا وسيلة دفع ذات قيمة مخزنة ويتم استردادها على الخادم مع حماية من الاستخدام المتزامن.',
  'Issue gift card':'إصدار بطاقة هدايا',
  'No gift cards issued.':'لم يتم إصدار بطاقات هدايا.',

  'LEGAL & TRUST':'القانون والثقة',
  'Published policies, terms and trust disclosures for Velora customers and sellers.':'السياسات والشروط وإفصاحات الثقة المنشورة لعملاء وبائعي Velora.',
  'Terms of Service':'شروط الاستخدام',
  'Privacy Policy':'سياسة الخصوصية',
  'Review Policy':'سياسة المراجعات',
  'AI Beauty Disclaimer':'إخلاء مسؤولية توصيات الجمال بالذكاء الاصطناعي',
  'Legal documents unavailable':'المستندات القانونية غير متاحة',
  'Loading published policies…':'جارٍ تحميل السياسات المنشورة…',
  'No published policy is available yet.':'لا توجد سياسة منشورة متاحة حتى الآن.',
  'Velora will publish customer policies here after the required review and approval process is complete.':'ستنشر Velora سياسات العملاء هنا بعد اكتمال المراجعة والموافقة المطلوبة.',
  'Legal page unavailable':'صفحة المستندات القانونية غير متاحة',
  'Document hash':'بصمة المستند',
  'Draft and version policies here. Publishing is owner-gated and legal validity still requires counsel review.':'جهّز نسخ السياسات هنا. النشر مقصور على الـOwner، والصلاحية القانونية تظل بحاجة لمراجعة المستشار القانوني.',
  'Require re-acceptance':'يتطلب إعادة القبول',
  'Save legal version':'حفظ النسخة القانونية',
  'Owner publishing is intentionally separate from staff drafting.':'فصل النشر لدى الـOwner عن إعداد المسودات مقصود لحوكمة المستندات.',
  'No legal versions configured.':'لا توجد نسخ قانونية مهيأة.',
  'Legal document published.':'تم نشر المستند القانوني.',
  'Saving…':'جارٍ الحفظ…',
  'Legal document type required':'نوع المستند القانوني مطلوب',
  'Legal owner approval is required':'موافقة الـOwner مطلوبة للنشر القانوني',
...
,
  ...
  'How to shop, sell, manage orders, and get the most from Velora.':'إزاي تشتري وتبيع وتدير طلباتك وتستفيدي من Velora.',
  'Blog':'المدونة',
  'Marketplace stories, shopping tips, and seller insights.':'قصص عن سوق الجمال ونصائح التسوق وإرشادات للبائعين.',
  'Smart Comparison':'مقارنة ذكية',
  'Choose any number of products and compare them in all details':'اختاري المنتجات اللي عايزة تقارني بينها وشوفي كل التفاصيل.',
  'Start Comparison':'ابدئي المقارنة',
  'Search for a product above and add it':'ابحثي عن منتج بالأعلى وأضيفيه للمقارنة.',
  'Real Reviews':'مراجعات حقيقية',
  'Read real experiences and share yours':'اقرئي تجارب حقيقية وشاركي تجربتك.',
  'My Wishlist':'قائمتي المفضلة',
  'Products you loved are saved here':'المنتجات اللي حبيتيها محفوظة هنا.',
  'Shopping Cart':'سلة المشتريات',
  'Review your items and proceed to checkout':'راجعي منتجاتك وانتقلي لإتمام الطلب.',
  'Checkout':'إتمام الطلب',
  'Complete your order':'أكملي طلبك.',
  'My Orders':'طلباتي',
  'Track your orders':'تابعي طلباتك.',
  'Your cart is empty':'سلة المشتريات فاضية.',
  'Start shopping to add products':'ابدئي التسوق لإضافة المنتجات.',
  'Shop Now':'تسوقي الآن',
  'Search':'بحث',
  'Comparison Result':'نتيجة المقارنة',
  'Subscribe for latest offers':'اشتركي لمعرفة أحدث العروض.',
