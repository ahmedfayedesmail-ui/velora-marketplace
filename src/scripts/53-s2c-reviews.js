...
if(typeof MutationObserver==='function'){
  const veloraS2CPlatformObserver=new MutationObserver(()=>{addAdminNav();addSellerNav()});
  if(document.body) veloraS2CPlatformObserver.observe(document.body,{childList:true,subtree:true});
  else document.addEventListener('DOMContentLoaded',()=>veloraS2CPlatformObserver.observe(document.body,{childList:true,subtree:true}),{once:true});
}
setTimeout(()=>{addAdminNav();addSellerNav()},1800);
