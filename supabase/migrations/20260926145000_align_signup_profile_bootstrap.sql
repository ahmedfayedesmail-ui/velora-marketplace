...
-- Keep the canonical signup bootstrap aligned with the actual identity model:
-- auth.users -> public.profiles -> public.user_roles, with public.users as
-- the existing compatibility profile used by legacy UI.
